...
SKIPPED_TAGS="3.2-?|wheezy|$SKIP_TF|$SKIP_MINOR_OS|$SKIP_NODE|$SKIP_DOCKER|$SKIP_MINIO|$SKIP_MAILU|$SKIP_MINOR|$SKIP_PRE|$SKIP_OS|$SKIP_PHP|$SKIP_WINDOWS|$SKIP_MISC"
CURRENT_TS=$(date +%s)
IMAGES_SKIP_NS="((mailhog|postgis|pgrouting(-bare)?|^library|dejavu|(minio/(minio|mc))))"


SKIPPED_TAGS="$SKIPPED_TAGS|(buster|bullseye|wheezy|jessie|stretch)"
...
library/python/3\
 library/python/slim\
 library/python/latest::30
library/python/3.12-alpine\
 library/python/3.12-slim\
 library/python/3.12::30
library/python/3.11-alpine\
 library/python/3.11-slim\
 library/python/3.11::30
library/python/3.10-alpine\
 library/python/3.10-slim\
 library/python/3.10::30
library/python/2\
 library/python/2-alpine\
 library/python/2-slim\
library/python/3.6-alpine\
 library/python/3.6-slim\
 library/python/3.6::30
"
